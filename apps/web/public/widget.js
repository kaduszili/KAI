(function(){"use strict";(function(){const b=document.currentScript,G=b==null?void 0:b.dataset.project,ie=((b==null?void 0:b.dataset.apiUrl)??"https://api.bentevi.tech").replace(/\/$/,"");if(!G){console.warn("[Bentevi] Missing data-project attribute.");return}let M=!1,I=!1;const k=[];let B="#6366f1",O="#6366f1",z="#6366f1",$="#f3f4f6",x="Bentevi",y=null,F="",v={},w="system",N="auto",V="circle",oe="AI-mode",P="solid",W=!1,j="#6366f1",_="#8b5cf6",D=null,Y="",ne="",R="#6366f1",Z="#6366f1",H="#334155",ae="",q="",C,u,d,a,g,l,p,E;const fe={inter:"Inter",roboto:"Roboto","open-sans":"Open Sans",nunito:"Nunito"};function ge(){return w==="system"?"-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif":`'${fe[w]??w}', sans-serif`}function me(){return P==="gradient"?`linear-gradient(135deg, ${j}, ${_})`:B}function be(){return P==="gradient"?j:B}function re(){return`
